...
- ภาพหน้าจอระบบยืนยันตัวตนและการจัดการสิทธิ์ ดังแสดงในภาพที่ 4.2 4.3 4.4 4.5 และ 4.6
    ...
    ### Figure 4.2 ภาพหน้าจอแสดงหน้าเข้าสู่ระบบ

    ### Figure 4.3 ภาพหน้าจอแสดงหน้าเข้าสู่ระบบที่กรอกข้อมูลผิด

    ### Figure 4.4 ภาพหน้าจอแสดงหน้าเข้าสู่ระบบที่กรอกข้อมูลถูกต้อง

    ### Figure 4.5 ภาพหน้าจอแสดงหน้าเข้าสู่ระบบของหัวหน้ากลุ่มงาน (1) [หน้า Login]

    ### Figure 4.6 ภาพหน้าจอแสดงหน้าเข้าสู่ระบบของหัวหน้ากลุ่มงาน (2) [หน้าหลังเข้ามาในระบบแล้ว]

- ภาพหน้าจอโครงการรวมทั้งหมดและระบบงานกลาง ดังแสดงในภาพที่ 4.7 4.8 และ 4.9

    ### Figure 4.7 ภาพหน้าจอแสดงหน้าโครงการรวมทั้งหมด

    ### Figure 4.8 ภาพหน้าจอแสดงฟีเจอร์การค้นหาขั้นสูง

    ### Figure 4.9 ภาพหน้าจอแสดงระบบงานกลางที่เจ้าหน้าที่พัสดุสามารถดึงงานเข้ามาในความรับผิดชอบของตนเองได้

- ภาพหน้าจอรายละเอียดโครงการ ดังแสดงใน ภาพที่ 4.10 และ 4.11

    ### Figure 4.10 ภาพหน้าจอแสดงรายละเอียดโครงการและการแนบไฟล์

    ### Figure 4.11 ภาพหน้าจอแสดงรายละเอียดโครงการและการแนบไฟล์ (2)

- ภาพหน้าจอเอกสารคู่มือ API (Swagger API Documentation) ดังแสดงในภาพที่ 4.12

    ### Figure 4.12 ภาพหน้าจอแสดงเอกสารคู่มือ API (Swagger API Documentation)
