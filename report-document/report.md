...
2. ส่วน frontend
    ...
    - TanStack Table (เวอร์ชัน 8) นำมาใช้สำหรับการแสดงผลและจัดการตารางข้อมูลที่ซับซ้อน เช่น ตารางโครงการ และตารางคลังงานส่วนกลาง
...
1. ความซับซ้อนในการจัดการสถานะโครงการและตรรกะของคลังงานส่วนกลาง
   ...
   - แนวทางแก้ไข: คณะผู้จัดทำได้แยกการทำงานตรรกะโครงการออกเป็นโมดูลต่าง ๆ อย่างชัดเจน ได้แก่ `project-lifecycle.service.ts` สำหรับการเปลี่ยนสถานะโดยรวม และ `project-assignment.service.ts` สำหรับดูแลคลังงานส่วนกลาง นอกจากนี้ยังมีการบังคับเงื่อนไขสถานะ (Guard Clauses) เพื่อป้องกันพฤติกรรมที่ไม่ถูกต้อง เช่น งานที่มีผู้รับผิดชอบแล้วจะไม่สามารถถูกเลือกซ้ำได้
...
- ภาพหน้าจอโครงการรวมทั้งหมดและคลังงานส่วนกลาง ดังแสดงในภาพที่ 4.7 4.8 และ 4.9
